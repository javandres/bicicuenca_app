...
Otp.getLayout = (page: React.ReactElement) => <DashboardLayout>{page}</DashboardLayout>;
...
export default function Otp() {
  ...
  const [geoportalUrl, setGeoportalUrl] = useState(process.env.NEXT_PUBLIC_GEOPORTAL_URL);
  // let Iref = useRef("");
